...
function ContactPage() {
  ...
  const sendMessage = (event: FormEvent) => {
    ...
    window.location.href = `mailto:bhuvneshp947@gmail.com?subject=${encodeURIComponent("KHANAN customer message")}&body=${encodeURIComponent(body)}`;
  };
